...
public class AdminOrderDao {
    ...
    public List<OrderAdminView> findOrdersByDateFilter(Integer day, Integer month, Integer year) {
        ...
        if (year != null) {
            sql.append(" WHERE YEAR(o.created_at) = ").append(year);
            hasWhere = true;
        }
        if (month != null) {
            sql.append(hasWhere ? " AND" : " WHERE");
            sql.append(" MONTH(o.created_at) = ").append(month);
            hasWhere = true;
        }
        if (day != null) {
            sql.append(hasWhere ? " AND" : " WHERE");
            sql.append(" DAY(o.created_at) = ").append(day);
        }
